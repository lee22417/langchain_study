...
def send_msg(msg, role, save=True):
    ...
    # 저장
    if save:
        st.session_state["msg_005"].append({"msg": msg, "role": role})


if "msg_005" not in st.session_state:
    st.session_state["msg_005"] = []

for msg in st.session_state["msg_005"]:
